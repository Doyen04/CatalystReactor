...
class TextCursor {
    ...
    moveCursor(
        ...
        switch (direction) {
            ...
            case 'right':
                ...
                break
            case 'up':
                this.cursorIndex = this.moveCursorUp(
                    text,
                    fontSize,
                    lineHeight,
                    paragraph
                ...
                break
            case 'down':
                this.cursorIndex = this.moveCursorDown(
                    text,
                    fontSize,
                    lineHeight,
                    paragraph
    ...
    private findCurrentAboveBelowLine(lineMetrics: LineMetrics[]): {
        ...
        for (let i = 0; i < totalLines; i++) {
            ...
            if (
                this.cursorIndex >= m.startIndex &&
                this.cursorIndex <= m.endIndex
            ) {
                currentLine = i
        ...
        const nextLine =
            currentLine < totalLines - 1 ? lineMetrics[currentLine + 1] : null
    ...
    private moveCursorUp(
        ...
        const coord = this.calculateCursorRect(
            text,
            fontSize,
            lineHeight,
            paragraph
    ...
    draw(canvas: Canvas): void {
        ...
        canvas.drawLine(
            ...
            this.y + this.textY,
            this.x + this.textX,
            this.y + this.textY + this.height,
            this.resource.strokePaint
        )
    }
