...
const BorderRadius = React.forwardRef<SVGSVGElement, LucideProps>(({ size, width, height, color, ...props }, ref) => (
    <svg ref={ref} width={width ?? size} height={height ?? size} fill="none" viewBox="0 0 24 24" stroke={color ?? 'currentColor'} {...props}>
        <path
            fillRule="evenodd"
            clipRule="evenodd"
