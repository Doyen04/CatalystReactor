...
interface SimpleColorInputProps
    extends Omit<React.HtmlHTMLAttributes<HTMLDivElement>, 'onChange'> {
    fill: string
    onChange: (value: string) => void
}

const SimpleColorInput = forwardRef<HTMLDivElement, SimpleColorInputProps>(
        ...
        return (
            ...
            items-center gap-1 p-0.5 border border-transparent cursor-pointer
             ...
             transition-colors ${className}`)}
                >
                    <p
                        className="font-semibold text-gray-700 h-4 w-4 rounded-sm"
                ...
                {isOpen && (
                    ...
                    >
                        ...
                        >
                            <ColorPicker
                                value={
                                    { type: 'solid', color: fill } as SolidFill
                                }
                                isOpen={isOpen}
                                onColorChange={color => {
