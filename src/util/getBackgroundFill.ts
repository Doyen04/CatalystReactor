import { PaintStyle, GradientFill, ImageFill, LinearGradient, RadialGradient, SolidFill } from '@lib/types/shapes'
...
function getDisplayTextFromFill(fill: PaintStyle): string {
    switch (fill.type) {
        case 'solid': {
